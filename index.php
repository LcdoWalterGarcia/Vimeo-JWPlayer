	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			...
			<div class="form-group">
				<label class="font-weight-bold">URL Vimeo:</label>
				<input type="text" name="link" class="form-control" placeholder="Ex: https://vimeo.com/146813378"this.select()" required>
			</div>
						...
						<div class="row">
						    <div class="col-md-7">
						        <div class="form-group">
						        	...
						        	<input type="text" class="form-control" name="sub[0]" placeholder="Ex: bundlecodes.com/api/apipanel/drop/the.boss.baby.srt (optional)" onclick="this.select()"> 
						        </div>
						    </div>
